...
public class StartUITest {
    ...
    public void whenUserAddItemThenTrackerHasNewItemWithSameName() {
        ...
        assertThat(tracker.getAll().get(3).getName(), is("test name")); // проверяем, что четвертый элемент массива в трекере содержит имя, введённое при эмуляции.
    }
    ...
    public void whenDeleteThenTrackerHasDeleteItem() {
        ...
        assertThat(tracker.getAll().get(1).getName(), is("Third"));
    }
